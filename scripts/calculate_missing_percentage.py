...
@click.command()
@click.option('--file_path', type=str, help="Path to directory where the input data locates")
@click.option('--output_file', type=str, help="Path to directory where the plot will be written to")
